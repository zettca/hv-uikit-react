...
_**Note:**_ Usage of a [IDE plugin](https://unocss.dev/integrations/vscode) is recommended for a better developer experience.
...
<Canvas>
  <Story name="Breakpoints">
    <section className="flex flex-col gap-xs text-atmo1">
