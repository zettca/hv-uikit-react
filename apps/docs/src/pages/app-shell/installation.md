...
Vite also provides a [CLI tool](https://www.npmjs.com/package/create-vite) to automatically set-up a project:
...
5. You are good to go! Run your brand new **App Shell** app! :rocket:
